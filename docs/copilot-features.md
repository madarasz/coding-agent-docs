...
| [Vision input in Copilot Chat](https://github.blog/changelog/2025-04-16-using-vision-input-in-copilot-chat-with-claude-and-gemini-is-now-in-public-preview) (public preview) | Copilot Chat accepts image uploads enabling screenshot-based debugging and visual context questions | Image attachment in Copilot Chat | N/A | Apr 2025 |
